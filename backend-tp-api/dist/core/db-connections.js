...
const GenericSqliteConnection_1 = require("./sqlite/generic/GenericSqliteConnection");
...
class MyAppConnectionMap extends my_db_connection_1.MyAbstractConnectionMap {
    constructor() {
        ...
        this.addConnection(new GenericSqliteConnection_1.MySqliteConnection("sqlite-test"));
