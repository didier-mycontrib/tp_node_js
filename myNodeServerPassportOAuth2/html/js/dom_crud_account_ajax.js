//variables globales:
//var accountWsUrl="../account-api/private";
var accountWsUrl="../account-api/public"; //V1 only (temp)
...
function loadAccountsWithAjax(){
    ...
    makeAjaxGetRequest(accountWsUrl+"/account" ,  function(texteReponse){
...
function postNewAccountWithAjax(nouvelleAccount){
    makeAjaxPostRequest( accountWsUrl+"/account" ,
...
function putNewValueOfExistingAccountWithAjax(accountToUpdate){
    makeAjaxPutRequest(accountWsUrl+"/account" ,
...
function deleteOldAccountWithAjax(oldAccount){
    let deleteUrl= accountWsUrl+"/account/" + oldAccount.username
